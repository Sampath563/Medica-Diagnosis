...
const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="flex justify-between items-center h-16">
      ...
      <div className="hidden md:flex items-center space-x-6">
        <Link to="/home" className="text-gray-800 hover:text-blue-600 font-medium">Home</Link>
        <Link to="/diagnosis" className="text-gray-800 hover:text-blue-600 font-medium">Health Diagnosis</Link>
        <Link to="/treatment" className="text-gray-800 hover:text-blue-600 font-medium">Treatment Planner</Link>
      </div>

      {/* Mobile Menu Button */}
      <div className="md:hidden flex items-center">
        <button onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)} className="text-gray-800 hover:text-blue-600 focus:outline-none">
  ...
  {isMobileMenuOpen && (
    <div className="md:hidden px-4 pb-4">
      <Link to="/home" className="block py-2 text-gray-800 hover:text-blue-600">Home</Link>
      <Link to="/diagnosis" className="block py-2 text-gray-800 hover:text-blue-600">Health Diagnosis</Link>
      <Link to="/treatment" className="block py-2 text-gray-800 hover:text-blue-600">Treatment Planner</Link>
    </div>
  )}
</nav>
